...
public class ProjectMainPresenter implements Presenter {
	public interface Display {
		Widget asWidget();
		HorizontalPanel getTabPanel();
	...
	public ProjectMainPresenter(UserProfileInfo currentUser,
